...
<ProfileContainer>
    ...
    <ProfileCard>
        <img class="profile-img" src="/images/content/team_taneesha.jpg" loading="lazy" alt="Taneesha">
        <div class="profile-caption">

            <h2>Taneesha Sharma</h2>
            <br/>
    ...
    <ProfileCard>
        <img class="profile-img" src="/images/content/team_cody.jpg" loading="lazy" alt="Cody">
        <div class="profile-caption">
